...
struct runtime_vertex {
    ...
    runtime_vertex(nullptr_t) : _ptr(0), _base_type(&typeid(nullptr)), _type(&typeid(nullptr)) {}
...
constexpr void trace_edge(const void*, void*, bool = false) {}
constexpr void trace_vertex_constructor(const void*) {}
constexpr void trace_vertex_destructor(const void*) {}
...
struct current_traced_vertex_updater {
    constexpr current_traced_vertex_updater(const void*) noexcept {}
};
}
